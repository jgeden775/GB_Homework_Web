...
$workexp = [
  [
    ...
    'date' => 'Январь 2020 - <span class="w3-tag w3-teal w3-round">Настоящее время</span>',
  ...
  [
    ...
    'date' => 'Сентябрь 2014 - Февраль 2016',
    'desc' => 'Lorem ipsum dolor sit amet. Praesentium magnam consectetur vel in deserunt aspernatur est reprehenderit
    sunt hic. Nulla tempora soluta ea et odio, unde doloremque repellendus iure, iste.',
    'hline' => ''
  ]
      ...
      <div class="w3-third">
        <div class="w3-white w3-text-grey w3-card-4">
          ...
          <!-- php begin -->
            ...
            <p><i class="fa fa-home fa-fw w3-margin-right w3-large w3-text-teal"></i><?= $country; ?></p>
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          <h2 class="w3-text-grey w3-padding-16">
            <i class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Опыт работы</h2>

          <!-- php begin -->
          <?php for ($i = 0; $i < count($workexp); $i++): ?>
            <div class="w3-container">
              <h5 class="w3-opacity"><b><?= $workexp[$i]['name']; ?></b></h5>
